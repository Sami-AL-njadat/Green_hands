        ...
        <form action="{{ route('store.Quick.donation') }}" class="donate-form" method="post" novalidate="novalidate">
            ...
            <ul class="chicklet-list clearfix">
                ...
                <div class="form-check form-check-inline">
                    ...
                    <li>
                        <input type="number" id="custom_amount" name="budget" placeholder="Enter the  amount" required>
                    </li>
...
<div class="container" id="Service_Donation">
    <div class="donate-form-area">
        ...
        <form action="{{ route('sorte.Quick.service') }}" class="donate-form" method="post" novalidate="novalidate">
            @csrf
            ...
            <div class="form-check form-check-inline">
                ...
                <div class="form-check form-check-inline">
                    <input type="checkbox" class="form-check-input" name="choosen_service2" value="Planting" required>
                    <label class="form-check-label"> Planting </label>
                </div>

                <div class="form-check form-check-inline">
                    <input type="checkbox" class="form-check-input" name="choosen_service3" value="Organizing" required>
        ...
        <form class="default-form" action="{{ route('store.Quick.item') }}" method="post" novalidate="novalidate">
            ...
            <div class="form-check form-check-inline">
                ...
                <div class="form-check form-check-inline">
                    ...
                    <input type="text" class="form-check-input" name="tree_type1" placeholder="Enter the tree type"
                        required><br>
                ...
                <div class="form-check form-check-inline">
                    ...
                    <input type="text" class="form-check-input" name="fertilizer" placeholder="Enter Fertilizer type"
                        required><br>
